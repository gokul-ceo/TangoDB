    ...
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      <div className="container">
        ...
        <Heading as="h1" className="heroBannerTitle margin-top--md">
          {siteConfig.title} <span style={{fontSize: '2rem', verticalAlign: 'middle', color: '#ff6d00'}}>v1.0.0</span>
        </Heading>
        <p className="heroBannerSubtitle">
          TangoDB v1.0.0 is a high-performance embedded key-value storage engine built from scratch in modern Java.
        </p>
        ...
        <div className="codeTeaser">
          <CodeBlock language="java" title="TangoDB v1.0.0 Quick Example">
...
export default function Home(): ReactNode {
  ...
  return (
    <Layout
      title={`${siteConfig.title} v1.0.0 - High-Performance Embedded Key-Value Storage`}
      description="TangoDB v1.0.0 experimental high-performance embedded key-value storage engine built from scratch in modern Java using FFM API and off-heap memory.">
      <HomepageHeader />
      <main>
